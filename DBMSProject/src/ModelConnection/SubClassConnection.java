...
public class SubClassConnection extends AbstractConnection{
	...
	public Timestamp convertString2Datetime(String date) throws ParseException
	{
		    ...
		    Date parsedDate;
			parsedDate = dateFormat.parse("10/23/2014 03:40:00");
	...
	//tìm danh sách đề mà giáo viên quản lý (cái này k chắc cho lắm)
	public Vector<DeMon> getAssignmentUnderControllOf(String teacherID)
	{
				...
				while (i!= columnsNumber + 1)
				{
					if ((i == 5) || (i == 9))
					{
						if (rs.getObject(i) == null)
							...
							Info.addElement(((Timestamp)rs.getObject(i)).toString());
					}
	...
	public Vector<DeMon> getAssignmentOf(String studentID)
	{
		Vector<DeMon> info = new Vector<DeMon>();
